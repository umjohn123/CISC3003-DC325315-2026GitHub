...
For commercial sites, themes, projects, and applications, keep your source code private/proprietary by purchasing a commercial license from https://scrollrevealjs.org/ */
var ScrollReveal = function () {
    ...
    function t() {
        var n = this;
        i.call(this), f(this.store.elements, function (e) {
        ...
        }), f(this.store.sequences, function (e) { -1 === r.active.indexOf(e.id) && r.stale.push(e.id); }), f(r.stale, function (e) { return delete n.store.sequences[e]; });
    }
    function N(e) {
    ...
    var S = function () {
        ...
        function e(e, t) {
            if (void 0 === t && (t = i), e && "string" == typeof e) {
                if (n[e]) return n[e];
                if ("string" == typeof t[e]) return n[e];
    ...
    function p(e) {
        ...
        if (parseFloat(i.distance)) {
            ...
            switch (O[1]) {
                case "em": k = parseInt(t.fontSize) * x; break;
                case "px": k = x; break;
                case "%": k = "Y" === T ? e.node.getBoundingClientRect().height * x / 100 : e.node.getBoundingClientRect().width * x / 100; break;
    ...
    function v(n) {
        ...
        if (s(n)) return f(e, function (e) { f(e, function (e, t) { s(e) ? (n[t] && s(n[t]) || (n[t] = {}), v(n[t], e)) : n[t] = e; }); }), n;
    ...
    function c(e, t) {
        void 0 === t && (t = {});
        var n = e.visible && !e.revealed, r = !e.visible && e.revealed && e.config.reset;
        ...
        }.call(this, e, t) : t.reset || r ? function (e) {
    ...
    function l(e) {
        var t = this.store.sequences[e.sequence.id], i = e.sequence.index;
        if (t) {
            var r = new d(t, "visible", this.store), o = new d(t, "revealed", this.store);
            if (t.models = { visible: r, revealed: o }, !o.body.length) {
    ...
    function q(e, t) {
        ...
        void 0 === e && (e = { type: "init" }), void 0 === t && (t = this.store.elements), x(function () {
            ...
            }), f(t, function (e) { (n || void 0 === e.geometry) && (e.geometry = R.call(i, e)), e.visible = function (e) {
                void 0 === e && (e = {});
